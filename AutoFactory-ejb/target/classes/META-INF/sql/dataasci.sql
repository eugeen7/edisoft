...
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (1,1,1,1500,70,'MTR-000-000-001','Карбюраторный 4 цилиндровый двигатель 1500 см3',1,TRUE);
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (2,1,1,2000,100,'MTR-000-000-002','Карбюраторный 4 цилиндровый двигатель 2000 см3',2,TRUE);
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (3,2,1,1600,120,'MTR-000-000-003','Инжекторный 4 цилиндровый двигатель двигатель1600 см3',null,TRUE);
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (4,2,1,2500,200,'MTR-000-000-004','Инжекторный 6 цилиндровый двигатель двигатель 2500 см3',4,TRUE);
...
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (7,4,1,2000,170,'MTR-000-000-007','Дизельный двигатель рядный 6 цилиндров 2000',7,TRUE);
Insert into MOTOR (MOTOR_ID,MTRTYPE_FK,VERSNUM,VOLUME,MTRPOWER,MOTORSN,MTDSC,MTR_USE,STACTIVE) values (8,5,1,3000,100,'MTR-000-000-008','Газодизельный 4 цилиндровый двигатель',null,TRUE);
